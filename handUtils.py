...
class HandDetector():
    ...
    # def fingers_count(self, img, hand='Left'):
    def fingers_count(self, hand='Left'):
        ...
        for tip in tips:
            ...
            if ltp1 and ltp2:
                # draw the finger point
                # cv2.circle(img, (ltp1[0], ltp1[1]), 10, (0, 0, 255), cv2.FILLED)
                # cv2.circle(img, (ltp2[0], ltp2[1]), 10, (255, 0, 0), cv2.FILLED)
